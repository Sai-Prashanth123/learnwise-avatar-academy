  ...
  const handleSubmit = () => {
    if (!inputType) {
      toast({
        ...
        description: "Please select the type of content you want to be quizzed on.",
        variant: "destructive"
      });
      return;
    }
    ...
    // For now, just navigate to the quiz session
    navigate('/quiz/session', { state: { inputType, content: file || content } });
  };
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Test your knowledge on any material</p>
      </div>

      <Card className="card-hover">
        <CardHeader>
          <CardTitle>What would you like to be quizzed on?</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            ...
            {inputType && (
              ...
              >
                ...
                {inputType === 'Text' && (
                  <div className="space-y-2">
                    <p className="text-sm text-gray-500">Enter the text you want to be quizzed on</p>
                    <Textarea
